...
```
```{r}
cormat <- round(cor(df[ , c('Happiness.score', 'Explained.by..GDP.per.capita', 'Explained.by..Social.support', 'Explained.by..Healthy.life.expectancy', 'Explained.by..Freedom.to.make.life.choices', 'Explained.by..Generosity', 'Explained.by..Perceptions.of.corruption')]),2)
