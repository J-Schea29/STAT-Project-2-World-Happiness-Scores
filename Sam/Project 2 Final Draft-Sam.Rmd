...
<br>
<p style="line-height:2; font-size:20px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The goal of this project is to use the data from the World Happiness Score to create a Linear Regression Model capable of predicting the happiness of a given country. Along the way the variables will be tested to determine their relevance to the linear regression in the data.</p>
<br>
...
str(df)
```
<center><h2> Scatter Plots Comparing the Independent Variables to the Dependent Variable (hs) </h2></center>
<br>
<div align="center">
